...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CashfreePG",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// \param payment An instance of <code>CFPayment</code> has to be sent to this method. ( Please read documentation <code>CFCardPayment</code>, <code>CFEMICardPayment</code>, <code>CFUPIPayment</code>, <code>CFWalletPayment</code>, <code>CFNetbankingPayment</code>, <code>CFQRCodePayment</code>, <code>CFNativeCheckoutPayment</code>)
///
/// \param viewController In case of native checkout, an instance of the view controller has to be sent mandatorily inorder to host the checkout page.
///
///
/// throws:
