...
install_xcframework "${PODS_ROOT}/CashfreeAnalyticsSDK/CashfreeAnalyticsSDK.xcframework" "CashfreeAnalyticsSDK" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
