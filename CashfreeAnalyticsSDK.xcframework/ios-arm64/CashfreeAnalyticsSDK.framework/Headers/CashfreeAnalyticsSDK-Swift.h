...
#ifndef CASHFREEANALYTICSSDK_SWIFT_H
#define CASHFREEANALYTICSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CashfreeAnalyticsSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface CFAnalytics (SWIFT_EXTENSION(CashfreeAnalyticsSDK))
...
@interface CFEvent (SWIFT_EXTENSION(CashfreeAnalyticsSDK))
