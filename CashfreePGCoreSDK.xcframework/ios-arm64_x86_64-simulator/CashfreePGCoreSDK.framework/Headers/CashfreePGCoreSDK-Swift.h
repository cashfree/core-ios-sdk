...
@class NSString;
SWIFT_CLASS("_TtC17CashfreePGCoreSDK11CFBankUtils")
@interface CFBankUtils : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This method returns list of installed banking applications on the user’s phone.
/// IMPORTANT: For this method to work correctly on iOS, the corresponding
/// URL schemes (e.g., “yono”, “au0101”) MUST be added to your host app’s
/// Info.plist under the ‘LSApplicationQueriesSchemes’ array.
///
/// returns:
/// An array of dictionary ([String: String]) is returned. Each object
/// consists of “displayName”, “id” (the URL scheme), and “icon” (Base64 string).
...
- (void)setCancelButtonVisibility:(BOOL)flag;
...
///
/// \endcode
SWIFT_CLASS("_TtC17CashfreePGCoreSDK10CFCardSubs")
@interface CFCardSubs : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// returns:
/// The method returns an instance of CFCardBuilder to continue building the CFCard object
- (CFCardSubsBuilder * _Nonnull)setChannel:(NSString * _Nonnull)channel SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the card number to the CFCard Object.
/// \param number The card number has to be sent as the parameter in String format.
///
///
/// returns:
/// The method returns an instance of CFCardBuilder to continue building the CFCard object
- (CFCardSubsBuilder * _Nonnull)setCardNumber:(NSString * _Nonnull)number SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the card holder’s name to the CFCard Object
/// \param name The card holders name has to be sent as the parameter.
///
///
/// returns:
/// The method returns an instance of CFCardBuilder to continue building the CFCard object
- (CFCardSubsBuilder * _Nonnull)setCardHolderName:(NSString * _Nonnull)name SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the card expiry month to the CFCard Object
/// \param month The card’s expiry month has to be sent as the parameter in “mm” format.
///
///
/// returns:
/// The method returns an instance of CFCardBuilder to continue building the CFCard object
- (CFCardSubsBuilder * _Nonnull)setCardExpiryMonth:(NSString * _Nonnull)month SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the card expiry year to the CFCard Object
/// \param year The card’s expiry year has to be sent as the parameter in “yy” format.
///
///
/// returns:
/// The method returns an instance of CFCardBuilder to continue building the CFCard object
- (CFCardSubsBuilder * _Nonnull)setCardExpiryYear:(NSString * _Nonnull)year SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the card cvv to the CFCard object
/// \param cvv The card’s cvv has to be sent as the parameter.
///
///
...
SWIFT_CLASS("_TtC17CashfreePGCoreSDK16CFNetBankingSubs")
@interface CFNetBankingSubs : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtCC17CashfreePGCoreSDK16CFNetBankingSubs23CFNetbankingSubsBuilder")
@interface CFNetbankingSubsBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (CFNetbankingSubsBuilder * _Nonnull)setBankAccountCode:(NSString * _Nonnull)code SWIFT_WARN_UNUSED_RESULT;
...
- (CFNetBankingSubs * _Nullable)buildAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
///
/// \endcode
SWIFT_CLASS("_TtC17CashfreePGCoreSDK23CFNetbankingSubsPayment")
@interface CFNetbankingSubsPayment : CFPayment
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)printDescription;
@end
...
/// The CFNetbankingPaymentBuilder class can be used to create an object of CFNetbankingObject. It consists of setter methods to set the values for <em>CFNetbanking</em>, <em>CFSession</em>. And finally a <em>build</em> method that returns an object of <em>CFNetbankingPayment</em>.
SWIFT_CLASS("_TtCC17CashfreePGCoreSDK23CFNetbankingSubsPayment30CFNetbankingSubsPaymentBuilder")
@interface CFNetbankingSubsPaymentBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This method sets the value for CFSession variable of the CFNetbankingPayment class
/// \param session It takes a parameter of type CFSession
///
...
/// returns:
/// It returns an instance of <em>CFNetbankingPaymentBuilder</em> to continue the build process
- (CFNetbankingSubsPaymentBuilder * _Nonnull)setNetbanking:(CFNetBankingSubs * _Nonnull)netbanking SWIFT_WARN_UNUSED_RESULT;
/// This method builds an object of <em>CFNetbankingPayment</em>
///
/// throws:
/// It throws an error (CashfreeError), in case <em>CFNetbanking</em> or <em>CFSession</em> is not set.
...
/// returns:
/// It returns an object of <em>CFNetbankingPayment</em>
- (CFNetbankingSubsPayment * _Nullable)buildAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
@optional
- (void)verifySubscriptionWithSubscription_id:(NSString * _Nonnull)subscription_id;
...
/// \code
/// let cfSession = ...
/// let cfSubscriptionPaymentObject = try CFSubscriptionPayment.CFSubscriptionPaymentBuilder()
///     .setSession(cfSession)
///     .build()
///
/// \endcode
SWIFT_CLASS("_TtC17CashfreePGCoreSDK21CFSubscriptionPayment")
@interface CFSubscriptionPayment : CFPayment
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)printDescription;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This method sets the value for CFSubscriptionSession variable of the CFSubscriptionPayment class
/// \param session It takes a parameter of type CFSubscriptionSession
///
///
/// returns:
/// It returns an instance of <em>CFSubscriptionPaymentBuilder</em> to continue the build process
- (CFSubscriptionPaymentBuilder * _Nonnull)setSession:(CFSubscriptionSession * _Nonnull)session SWIFT_WARN_UNUSED_RESULT;
/// This method builds an object of <em>CFSubscriptionPayment</em>
///
/// throws:
/// It throws an error (CashfreeError), in case <em>CFSubscriptionSession</em> is not set.
///
/// returns:
/// It returns an object of <em>CFSubscriptionPayment</em>
- (CFSubscriptionPayment * _Nullable)buildAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC17CashfreePGCoreSDK21CFSubscriptionSession")
@interface CFSubscriptionSession : NSObject
- (void)printDescription;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// This class provides builder methods that help in creating an object of <code>CFSession</code>
SWIFT_CLASS("_TtCC17CashfreePGCoreSDK21CFSubscriptionSession28CFSubscriptionSessionBuilder")
@interface CFSubscriptionSessionBuilder : NSObject
/// No Arguments Constructor
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// The method sets the value of the generated token to the CFSubscriptionSession Object (The subscription creation should be strictly a server to server call)
/// \param subscriptionSessionId Send the payment_session_id that is generated. The payment_session_id consists of the entire order details.
///
///
/// returns:
/// The method returns an instance of CFSubscriptionSessionBuilder to continue building the CFSubscriptionSession object
- (CFSubscriptionSessionBuilder * _Nonnull)setSubscriptionSessionId:(NSString * _Nonnull)subscriptionSessionId SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the subscription Id to the CFSubscriptionSession Object (The order creation should be strictly a server to server call)
/// \param id Send the subscription Id of the subscription under process.
///
///
/// returns:
/// The method returns an instance of CFSubscriptionSessionBuilder to continue building the CFSubscriptionSession object
- (CFSubscriptionSessionBuilder * _Nonnull)setSubscriptionId:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
/// The method sets the value of the environment in which the payment has to be executed
/// \param environment The value of the environment can be either SANDBOX or PRODUCTION depending on the environment the payment has to be executed
///
///
/// returns:
/// The method returns an instance of CFSubscriptionSessionBuilder to continue building the CFSubscriptionSession object
- (CFSubscriptionSessionBuilder * _Nonnull)setEnvironment:(enum CFENVIRONMENT)environment SWIFT_WARN_UNUSED_RESULT;
/// The method validates the input, to check if the inputs are either nil or empty
///
/// throws:
/// In case of validation failure, a custom error adhering to Error protocol is thrown.
///
/// returns:
/// The method returns a CFSubscriptionSession Object, which has to be used further in the integration process
- (CFSubscriptionSession * _Nullable)buildAndReturnError:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
@end
...
///
/// \endcode
SWIFT_CLASS("_TtC17CashfreePGCoreSDK9CFUPISubs")
@interface CFUPISubs : NSObject
- (void)printDescription;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// The <em>CFUPIBuilder</em> class consists of all the setter methods required to create an object of <code>CFUPI</code>
SWIFT_CLASS("_TtCC17CashfreePGCoreSDK9CFUPISubs16CFUPISubsBuilder")
@interface CFUPISubsBuilder : NSObject
/// No Argument Constructor
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// This method sets the UPI ID of the user in case of UPI Collect flow or the UPI application that has to be launched in case of UPI Intent flow to which the payment notification gets triggered.
/// \param id It is of type String and the <em>upi_vpa</em> value or the <em>id</em> of the installed application has to be sent as the value to this id
...
/// returns:
/// It returns an instance of <em>CFUPIBuilder</em> to further continue building an object of <em>CFUPI</em>
- (CFUPISubsBuilder * _Nonnull)setUPIID:(NSString * _Nonnull)id SWIFT_WARN_UNUSED_RESULT;
/// This methods creates an object of CFUPICollect by setting the value of channel and upi_id and returns the object back to the calling method
///
/// throws:
/// In case the value is null or empty an Error (CashfreeError.UPI_ID_MSSING) is thrown and the exception can be handled gracefullt
